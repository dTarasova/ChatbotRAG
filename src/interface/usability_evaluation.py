...
st.write("""Hi there! This is the LLM-based educational chatbot for Requirements Engineering (RE).   \n It uses evidence-based data sources to provide users in-depth insights on the topic.
            \n This chatbot's primary purpose is to explain concepts, suggest techniques and provide examples in the Requirements Engineering domain. 
             """)
